...
var score = points.value;
var fullName = firstName + " " + lastName;

// create a var that adds the full name var and score in a message
var leaderboardPlayer = fullName + " - Score: " + score; // maybe??
var gameEndWindowText = "Congratulations, " + fullName + " you've finished the game with a score of: " + score + " points!" // or this?
